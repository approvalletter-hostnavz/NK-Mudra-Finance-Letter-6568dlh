function showInput() {
  ...
  document.getElementById('yearstype').innerHTML =
    document.getElementById("yearstype_input").value;
  ...
  document.getElementById('accc').innerHTML =
    document.getElementById("acc_inputc").value;

  document.getElementById('ifscc').innerHTML =
    document.getElementById("ifsc_inputc").value;

  document.getElementById('bankc').innerHTML =
    document.getElementById("bank_inputc").value;
}
...
//Company Account
const selectElementc = document.getElementById('acSelect');
const divc = document.getElementById('comAcc');

selectElementc.addEventListener('change', function() {
  if (this.value === 'yes') {
    divc.style.left = '0';
  } else if (this.value === 'no') {
    divc.style.left = '-100%';
...
const validUntil = new Date("2025-09-23T12:32:00+05:30"); // Set your expiry date/time
